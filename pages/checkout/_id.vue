                    ...
                    <div class="form-check mb-3 font-weight-bold">
                      ...
                      <label class="form-check-label" for="payment-paypal">
                        <img
                          :src="
                            $getStaticImage(
                              'payment/iconfinder_paypal_1220357.png'
                            )
                          "
                          alt="Paypal Icon"
                          class="icon"
                    ...
                    <div class="form-check mb-3 font-weight-bold">
                      ...
                      <label class="form-check-label" for="payment-cc">
                        <img
                          :src="
                            $getStaticImage(
                              'payment/icons8-mastercard-credit-card-96.png'
                            )
                          "
                          alt="Card Icon"
                          class="icon"
                        ...
                        >
                          ...
                          <div class="available-card">
                            <img
                              ...
                              :src="$getStaticImage('payment/visa-logo.png')"
                              alt="Visa Icon"
                            />
                            <img
                    ...
                    <div class="form-check mb-3 font-weight-bold">
                      ...
                      <label class="form-check-label" for="payment-new">
                        <img
                          :src="
                            $getStaticImage(
                              'payment/icons8-card-payment-96.png'
                            )
                          "
                          alt="Card Icon"
                          class="icon bigger"
    ...
    applyVoucher() {
      ...
      this.$axios
        ...
        .then(response => {
          ...
          if (success) {
            // when voucher valid, it will request new order detail
            this.getDetail()
          } else {
