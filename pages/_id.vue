    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12 col-md-11 mx-auto text-center">
                ...
                <h6 class="mb-4 mt-5">
                    <span class="badge badge-primary text-uppercase mx-2 py-2 px-3" v-for="tag in productMaster.productTagMaster" :key="tag.id">{{ tag.tagMaster && tag.tagMaster.name }}</span>
                </h6>
        ...
        <div class="row pt-5">
            <div class="col-12 col-md-6 mb-4" v-for="feature in productMaster.productTLDRMaster" :key="feature.id">
                <LazyKeyFeature :description="feature.description" />
            </div>
        </div>
        <LazyImageParagraphSideBySide :title="productMaster.title2" :imageUrl="$getImageOther(productMaster.id, 2)" :descriptions="[
          productMaster.description2
        ]" />
        <LazyImageParagraphSideBySide :rtl="true" :title="productMaster.title3" :imageUrl="$getImageOther(productMaster.id, 3)" :descriptions="[
          productMaster.description3
        ]" />
        <LazyVideoEmbedDescription :title="productMaster.videoTitle" :videoUrl="productMaster.videoURL" :descriptions="[
