<template>
  <div>
      ...
      <div class="row">
        <div class="col-12 col-md-11 mx-auto text-center">
          ...
          <h1 class="display-5 font-weight-normal d-block d-md-none">
            Launch Your Workflow into Hyperspace with
            <span class="text-red title-1 font-weight-bold"
              >Saastronautics</span
            >
          </h1>
        </div>
      ...
      <div class="row hero">
        <div class="col-12 text-center pt-5 pb-4">
          <img
            ...
            alt="Saastronautics Connecting People"
          />
        </div>
      </div>
      <!-- main feature -->
    ...
    <LazyCustomerFeedback
      ...
      subtitle="Read what our fellow Saastronauts have to say about us."
    />
    <!-- best selling -->
    <div class="container">
      <div class="row">
      ...
      <div class="row mt-5">
        ...
        >
          ...
          <nuxt-link class="maison-demi" :to="`/${item.productMaster.uniqName}`"
            >Learn More &#8594;</nuxt-link
          >
        </div>
        <div
          v-for="n in 3 - this.bestSellingProduct.length"
          :key="n"
          class="col-12 col-md-4 product mb-5 px-4 pb-3"
        >
          <LazyComingSoon />
