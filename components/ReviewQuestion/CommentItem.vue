    ...
    <div class="d-flex">
      ...
      <div class="flex-grow-1">
        ...
        <p class="">
          ...
          aliquip ex eas commodo consequat. Duis aute irure dolor in repren
          henderit in voluptate velit esse cillum dolore eu fugiat is nulla
          pariatur. Quis nostrud exercitation ullamco laboris nisi ut aliquip.
          Duisai aute irure dolor in reprehenderit in voluptate velit esse
          cilium dolore eu fugiat nulla pariatur. Excepteur sint occaecat
          cupidatat nonis proident, sunt in culpa qui officia deserunt mollit
          anim id est laborum.
        </p>
        <div class="reply">
          <h6 class="my-4">
