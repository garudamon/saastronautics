<template>
  <div class="row">
    <div
      class="col-12 col-md-4 text-center mb-5"
      v-for="item in member"
      :key="`${item.name}-${item.position}`"
    >
      <div class="team-member py-3 py-md-4 mx-md-2 px-3 px-md-4">
        <div class="p-3">
        ...
        <p>
          <a href="#"><i class="fa px-3 fa-facebook"></i></a>
          <a href="#"><i class="fa px-3 fa-instagram"></i></a>
          <a href="#"><i class="fa px-3 fa-linkedin"></i></a>
        </p>
      </div>
    </div>
  </div>
